              ...
              #  break
                ...
                if rand(0,1)<0.33: # Probablity p=0.33
                    ...
                    for i in xrange(np.size(Step)):
                        xNew=xn; xNew[randIndx]=Step[i]; print score(xNew,emax,emin)
